...
class o_OutlineInputBorder extends StatefulWidget {
  @override
  o_OutlineInputBorderState createState() {
    return o_OutlineInputBorderState();
  }
}

class o_OutlineInputBorderState extends State<o_OutlineInputBorder> {
  @override
  Widget build(BuildContext context) {
    // TODO: implement build
    return Scaffold(
      appBar: AppBar(
        title: Text('OutLineInputBorder'),
        leading: IconButton(
