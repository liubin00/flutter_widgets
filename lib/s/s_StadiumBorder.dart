...
class s_StadiumBorder extends StatefulWidget {
  @override
  s_StadiumBorderState createState() {
    return s_StadiumBorderState();
  }
}

class s_StadiumBorderState extends State<s_StadiumBorder> {
  @override
