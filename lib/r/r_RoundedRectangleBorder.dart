...
class r_RoundedRectangleBorder extends StatefulWidget {
  @override
  r_RoundedRectangleBorderState createState() {
    return r_RoundedRectangleBorderState();
  }
}

class r_RoundedRectangleBorderState extends State<r_RoundedRectangleBorder> {
  @override
  Widget build(BuildContext context) {
    // TODO: implement build
    return Scaffold(
      appBar: AppBar(
        title: Text('RoundedRectangBorder'),
        leading: IconButton(
